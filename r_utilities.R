...
get_data_dictionary <- function() {
  tibble::tribble(
    ...
    "providerHcrisIsRural","Rural flag from the cost report (0=urban,1=rural)",
    "providerHcrisBedsTotal","Total hospital beds from the cost report",
    ...
    "providerHcrisResidents","Number of interns and residents (FTE) from the cost report",
