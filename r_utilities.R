...
get_data_dictionary <- function() {
  tibble::tribble(
    ...
    "hcrisIsRural",    "Rural flag from the cost report (0=urban,1=rural)",
    "hcrisBedsTotal",  "Total hospital beds from the cost report",
    "hcrisBedsTotalGroup","Bed-size group (0=<100,1=100-399,2=>=400)",
    "hcrisBedsIcu",    "Intensive care beds from the cost report",
    "hcrisBedsCriticalCare","Intensive plus coronary, burn, surgical and other special care beds",
    "hcrisResidents",  "Number of interns and residents (FTE) from the cost report",
