...
get_data_dictionary <- function() {
  tibble::tribble(
    ...
    "providerHsa",     "Dartmouth Atlas hospital service area number of facility ZIP (2019 crosswalk after 2019)",
    "providerHrr",     "Dartmouth Atlas hospital referral region number of facility ZIP (2019 crosswalk after 2019)",
    "providerHrrCity", "City naming the facility hospital referral region",
    "providerHrrState","State of the city naming the facility hospital referral region",
    ...
    "posZip",          "5-digit ZIP of the provider address in the POS file",
    "posAddress",      "One-line provider address from the POS file (STREET, CITY, ST ZIP; upper case, trimmed), the geocoding key",
    "posLat",          "Latitude of posAddress from the Google Geocoding API (hospitals only, else NA)",
    "posLng",          "Longitude of posAddress from the Google Geocoding API (hospitals only, else NA)",
    "posGeocodeLocationType","Precision of the geocoded point: ROOFTOP, RANGE_INTERPOLATED, GEOMETRIC_CENTER or APPROXIMATE",
    "posGeocodeFormattedAddress","Address the Google Geocoding API resolved posAddress to",
    "posGeocodePartialMatch","1 if the API could not match the whole posAddress and returned a similar one, else 0",
    "posGeocodeStatus","Google Geocoding API status for posAddress: OK or ZERO_RESULTS",
    ...
    "providerHcrisIsRural","Rural flag from the cost report, at the start of the reporting period (0=urban,1=rural)",
    "providerHcrisBedsTotal","Total hospital beds from the cost report (adults and peds, all special care, and nursery)",
    "providerHcrisBedsTotalGroup","Bed-size group (0=<100,1=100-399,2=>=400)",
    "providerHcrisBedsIcu","Intensive care beds from the cost report",
    "providerHcrisBedsCriticalCare","Intensive plus coronary, burn, surgical and other special care beds",
    "providerHcrisResidents","Number of interns and residents (FTE) from the cost report, whole facility including subproviders",
    "providerHcrisResidentToBedRatio","Intern and resident to bed ratio (IRB) CMS computes for the IME payment (Worksheet E Part A line 19); 0 if no residents, NULL if residents but no IME calculation filed (non-IPPS)",
    ...
    "ahaIcuHos",       "AHA medical/surgical ICU at hospital level (0/1, raw field MSICHOS)",
